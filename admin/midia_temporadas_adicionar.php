...
if(!isset($_GET['midia_id']) OR !intval($_GET['midia_id']) OR !isset($_GET['midia_tipo']) OR
   !midia_tipo($_GET['midia_tipo']) OR empty(get_midia_por_id($_GET['midia_id'], $_GET['midia_tipo']))){
...
$page_title = 'Adicionar Temporada '.midia_tipo_single_title($res['midia_tipo']);
  ...
  <div class="card-body"> 
        ...
        <form class="row" id="form-temporadas" autocomplete="off">
            <div class="form-group col-12">
                ...
                <input type="text" class="form-control" name="temporada_titulo">
            </div>
            <div class="form-group col-12">
